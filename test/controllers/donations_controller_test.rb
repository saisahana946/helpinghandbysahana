...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, donar_name: @donation.donar_name, getter_id: @donation.getter_id, need_user: @donation.need_user } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, donar_name: @donation.donar_name, getter_id: @donation.getter_id, need_user: @donation.need_user } }
